...
data_path <-  params$paths$deployment_auto_qc
sites_path <- params$paths$sites
metadata_path <- params$paths$deployment_metadata
preceding_auto_qc <- params$paths$preceding_auto_qc
...
p <- bb_plot(d, dl,
             ...
             threshold_labels = c("Max Site Temp (TDsh, TCsh)",
                                  ...
                                  "Min Temp (TDl, TCl)"),
             threshold_colors = rgb(1, 0, 0, .8), 
             range_limit = c(bb_options("plot_min_temp"), bb_options("plot_max_temp")))
