...
plot_ts(core, y = core$DO_Pct_Sat, x_lab = plot$x_label, y_lab = plot$y_label)
```

```{r echo = FALSE, warning = FALSE, fig.cap = plot_info['do', 'caption']}
plot <- plot_info['do', ]
plot_ts(core, y = core$DO, x_lab = plot$x_label, y_lab = plot$y_label, hline = 6)
```

```{r echo = FALSE, warning = FALSE, fig.cap = plot_info['do_daily_range', 'caption']}
plot <- plot_info['do_daily_range', ]
plot_ts(daily, x = daily$Date, y = daily$DO_range, x_lab = plot$x_label, y_lab = plot$y_label, point_size = 1)
```

```{r echo = FALSE, warning = FALSE, fig.cap = plot_info['do_daily_min', 'caption']}
plot <- plot_info['do_daily_min', ]
plot_ts(daily, x = daily$Date, y = daily$DO_min, x_lab = plot$x_label, y_lab = plot$y_label, point_size = 1)
```

<!-- pair_mean_do_temp - I'm leaving this for later -->

```{r echo = FALSE, warning = FALSE, fig.cap = plot_info['daily_pct_under_6', 'caption']}
plot <- plot_info['daily_pct_under_6', ]
plot_ts(daily, x = daily$Date, y = daily$DO_6_pct, x_lab = plot$x_label, y_lab = plot$y_label, point_size = 1)
```
...
plot_ts(daily, x = daily$Date, y = daily$salinity, x_lab = plot$x_label, y_lab = plot$y_label, point_size = 1)
```
