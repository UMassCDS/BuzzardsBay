...
plot <- plot_info['do', ]
make_plot(core, y = core$DO, x_lab = plot$x_label, y_lab = plot$y_label, hline = 6, vline = core$Date_Time[core$Deployment])
```
...
if(salinity) {
   ...
   make_plot(core, y = core$Salinity, x_lab = plot$x_label, y_lab = plot$y_label, vline = core$Date_Time[core$Deployment])
}
```
